module.exports = {
  ...
  content: ["./public/**/*.html", "./src/**/*.{js,jsx,ts,tsx,vue}", './node_modules/preplaced-call-service/dist/**/*.js'],
  ...
  theme: {
    ...
    backgroundImage: {
      ...
      "login-screen-right-side-image":
        "url('/src/assets/images/Login-Screen/right-side.png')",
      "profile-banner-background-image":
        "url('/src/lib/assets/images/Profile/Pattern-Background.png')",
      "new-profile-banner-background-image":
        "url('/src/lib/assets/Icons/bg-public-profile.svg')",
      "pending-actions":
        "linear-gradient(180deg, rgba(255, 255, 255, 0) -6%, rgba(255, 255, 255, 0.5) 9.58%, #FFFFFF 80.53%)",
    },
    ...
    extend: {
      ...
      backgroundImage: {
        "split-white-gray":
          "linear-gradient(to bottom, #FFFFFF 78% , #E4E7EC 22%);",
        "accordion-split-white-gray":
          "linear-gradient(to bottom, #FFFFFF 88% , #E4E7EC 12%);",
        "trial-expectations-background":
          "linear-gradient(180deg, #D9D9D9 78.12%, #FFFFFF 100%)",
      },
    },
  },
  variantOrder: [
